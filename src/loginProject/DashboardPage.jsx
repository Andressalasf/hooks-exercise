      ...
      <div className="w-full max-w-md rounded-2xl border border-slate-200 bg-white p-10 text-center shadow-[0_20px_50px_rgba(15,23,42,0.08)]">
        ...
        <div className="mt-8 flex flex-col gap-3">
          <button
            ...
            className="w-full rounded-lg bg-red-500 px-5 py-2.5 font-['Space_Grotesk'] text-sm font-bold text-white transition hover:brightness-110 disabled:opacity-60 disabled:cursor-not-allowed"
          >
