    ...
    <section className="relative pt-[150px] pb-28 overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-5 md:px-20 text-center">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3.5 mb-16">
          ...
          <Link
            to="/playground"
            className="flex items-center gap-2 bg-white text-slate-900 px-7 py-3.5 rounded-xl font-['Space_Grotesk'] font-semibold text-[15px] hover:bg-slate-50 transition-colors"
            style={{ ...hairline}}
          >
